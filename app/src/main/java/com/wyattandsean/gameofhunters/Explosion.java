...
public class Explosion
{
    ...
    public int explosionFrameNumber, explosionX, explosionY;

    public Explosion(Context context)
    {
        this.setExplosion(context);
    }

    private void setExplosion(Context context)
    {
    ...
    public Bitmap getExplosion(int explosionFrameNumber)
    {

        return explosion[explosionFrameNumber];
    }
